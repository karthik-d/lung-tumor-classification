...
from keras.layers.convolutional import SeparableConv2D, MaxPooling2D, AveragePooling2D
...
if __name__ == '__main__':
        train_data_dir = 'color_trainset/'
        test_data_dir = 'color_testset/'
        ...
        model.summary()
        opt = Nadam(
    lr=0.001, beta_1=0.9, beta_2=0.999, epsilon=1e-05)
        # compile the model
